...
| `kirocrew agent list/create/update/delete/reset-model` | Manage Kiro Crew agent definitions. Create/update validate a model pin before persisting it — see [providers.md](providers.md). |

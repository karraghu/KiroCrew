...
| picking or defaulting a model anywhere | [model-selection](docs/system-specs/common/model-selection.md) + [model-fallback](docs/system-specs/features/model-fallback.md) |
...
| the publicly selectable Claude backend | [claude-code-provider](docs/system-specs/features/claude-code-provider.md) |
...
<!-- TODO(#8879): restore this row once docs/system-specs/modules/connections.md
     lands; docs-lint fails the link until then.
| connections, connectors, an external account link | connections spec |
-->

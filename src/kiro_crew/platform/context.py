...
# Callbacks run on EVERY install of ``_ACTIVE``, so a consumer that must re-derive
# something from the new ceiling is PUSHED the change instead of polling for it.
#

...
export const TOOL_ROW_PROJECT = '/home/user/workspace/demo-app'
...
export const TOOL_ROW_LAST_PURPOSE = 'Start a clean npm ci in the Node 22 container'
 ...
 */
export async function openToolRowScene(page, { base, slotKey, scene, theme = 'light' }) {
  let wsServer = null
  ...
  await page.route('**/api/**', async route => {
    ...
    return handleBootRoute(route, path, { project: TOOL_ROW_PROJECT, theme, fixedApi })
  })
